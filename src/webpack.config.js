...
module.exports = {
    entry: {
        ...
        // This key (app) will be our output JS and CSS filenames because (see below) we use the [name] replacement variable
        'app': [
    ...
    plugins: [
        ...
        new MiniCssExtractPlugin({
            ...
            // Output CSS filename, [name] will be the key `app` from above (same as the JS [name])
            filename: '[name].css',
